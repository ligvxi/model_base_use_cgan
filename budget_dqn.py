...
budget = 200000
initializeReplayBuffer = 128  # experience 10000 timesteps before start training #PAPER:50000
...
def startTraining():
    ...
    while (lastResult < 14.5):
        ...
        while not (d):
            ...
            if flag:
                flag = memory.addExperience(state, a, real_r, d, newState)
        ...
        filename = "CGANModel/budget/pong/model_" + str(episode).zfill(3) + ".npz"
    ...
    with tf.Session() as sess:
        try:
            ...
            memory = replayMemory(sizeMemory=repBufferSize, sampleSize=sampleSize, image_height=height,
                                  image_width=width, num_frames=4,budget=budget)
